    ...
    <div className='dark:text-white dark:bg-slate-900 w-full h-full'>
      ...
      <div className='md:mx-auto px-4 py-8 max-w-4xl lg:max-w-5xl box-border'>
        ...
        {loading ? (
          ...
          <svg role="status" className="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
