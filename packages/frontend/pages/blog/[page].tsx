...
import { ChevronLeftOutlined, ChevronRightOutlined, GlobeAltOutlined } from '@emmda-design/icons'
    ...
    <Layout>
      <main>
        ...
        <div className='pagination flex justify-between'>
          <button className={iconClass} onClick={() => go(page - 1)} disabled={page === 1}>
            <ChevronLeftOutlined />
          </button>
          <span>{page} / {pageCount}</span>
          <button className={iconClass} onClick={() => go(page + 1)} disabled={page === pageCount}>
